...
server.registerTool("update_repo_metadata", {
...
server.registerTool("change_repo_visibility", {
...
server.registerTool("list_all_repos", {
...
server.registerTool("unstar_repo", {
...
server.registerTool("list_all_issues", {
...
server.registerTool("get_repo_views", {
...
server.registerTool("get_repo_clone_count", {
...
server.registerTool("get_top_referrers", {
...
server.registerTool("get_top_paths", {
    title: "Get Top Paths",
...
server.registerTool("get_contributor_stats", {
...
server.registerTool("get_commit_activity", {
...
server.registerTool("list_followers", {
...
server.registerTool("close_pull_request", {
...
server.registerTool("get_logging_data", {
...
server.registerTool("list_recent_discord_messages", {
