...
export async function getRepoViews({ owner = repo_owner, repo, per }) {
    ...
    try {
        ...
        await logInteraction("get_repo_views", logInput, `View count of repo : ${owner}/${repo} is successfully fetched.`, "success", owner, targetRepo);
        return data;
    }
    catch (err) {
        let errorMsg = extractErrorMessage(err) || "An unknown error occurred.";
        await logInteraction("get_repo_views", logInput, errorMsg, "error", owner, targetRepo);
        throw err;
    }
}
// Function to get the clone count of a repository 
export async function getRepoCloneCount({ owner = repo_owner, repo, per }) {
    ...
    try {
        ...
        await logInteraction("get_repo_clone_count", logInput, `clone count of repo : ${owner}/${repo} is successfully fetched.`, "success", owner, targetRepo);
        return data;
    }
    catch (err) {
        let errorMsg = extractErrorMessage(err) || "An unknown error occurred.";
        await logInteraction("get_repo_clone_count", logInput, errorMsg, "error", owner, targetRepo);
        throw err;
    }
}
// Function to get the top Referrers of a repository 
export async function getTopReferrers({ owner = repo_owner, repo }) {
    ...
    try {
        ...
        await logInteraction("get_top_referrers", logInput, `Top Referrers of repo : ${owner}/${repo} are successfully fetched.`, "success", owner, targetRepo);
        return data;
    }
    catch (err) {
        let errorMsg = extractErrorMessage(err) || "An unknown error occurred.";
        await logInteraction("get_top_referrers", logInput, errorMsg, "error", owner, targetRepo);
        throw err;
    }
}
// Function to get the top paths of a repository 
export async function getRepoTopPaths({ owner = repo_owner, repo }) {
    ...
    try {
        ...
        await logInteraction("get_top_paths", logInput, `Top paths of repo : ${owner}/${repo} are successfully fetched.`, "success", owner, targetRepo);
        return data;
    }
    catch (err) {
        let errorMsg = extractErrorMessage(err) || "An unknown error occurred.";
        await logInteraction("get_top_paths", logInput, errorMsg, "error", owner, targetRepo);
        throw err;
    }
}
// Function to get the contributor statistics of a repository
export async function getRepoContributorStats({ owner = repo_owner, repo }) {
    ...
    try {
        ...
        await logInteraction("get_contributor_stats", logInput, `Contributor stats of repo : ${owner}/${repo} are successfully fetched.`, "success", owner, targetRepo);
        return data
        ...
        let errorMsg = extractErrorMessage(err) || "An unknown error occurred.";
        await logInteraction("get_contributor_stats", logInput, errorMsg, "error", owner, targetRepo);
        throw err;
    }
}
// Function to get the weekly commit activity of a repository
export async function getRepoCommitActivity({ owner = repo_owner, repo }) {
    ...
    try {
        ...
        await logInteraction("get_commit_activity", logInput, `Commit activity of repo : ${owner}/${repo} is successfully fetched.`, "success", owner, targetRepo);
        ...
        let errorMsg = extractErrorMessage(err) || "An unknown error occurred.";
        await logInteraction("get_commit_activity", logInput, errorMsg, "error", owner, targetRepo);
        throw err;
    }
}
